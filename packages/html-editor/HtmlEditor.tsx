...
import { PanelRightClose, PanelRightOpen, Wand2, Globe } from 'lucide-react';
    ...
    return (
        <div className="flex h-full w-full">
                        ...
                        <>
                            ...
                            >
                                <div className="flex justify-between items-center mb-2 h-6">
                                    <div className="text-xs font-bold text-slate-500 uppercase tracking-wider">Browser Preview</div>
            ...
            <ToolsPanel 
                ...
                activeEditorType={EditorType.HTML_PAGE}
